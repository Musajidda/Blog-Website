            ...
            <div class="card m-3 p-2">
                ...
                <div class="card-body">
                    <div class="btn btn-outline-secondary">
                        ...
                        <label for="img"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="icons d-flex gap-2">
                        ...
                        <button class="btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" class="bi bi-type-underline" viewBox="0 0 16 16">
                                <path
                    ...
                    <textarea name="bg_content" placeholder=" write blog here ....." id="" cols="100"
                        rows="17"></textarea>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-person-fill" viewBox="0 0 16 16">
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                        </svg> Auther : <span><?php echo $user_row['name'];?></span>
                    </div>
                    <label for=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
