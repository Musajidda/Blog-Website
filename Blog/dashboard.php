    ...
    <body>
        ...
        <div class="dashboard">
            ...
            <div class="dashboard-box">
                ...
                <div class="card shadow">
                    <div class="title border-end p-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-eye"
                            viewBox="0 0 16 16">
                            <path
                ...
                <p>created by <span class="text-primary">DreamCoders</span> | all rights reserved!</p>
            </div>
        </div>
